...
public class TransactionId implements org.apache.thrift.TBase<TransactionId, TransactionId._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionId> {
  ...
  private static final org.apache.thrift.protocol.TField POOL_SEQ_FIELD_DESC = new org.apache.thrift.protocol.TField("poolSeq", org.apache.thrift.protocol.TType.I64, (short)1);
  ...
  private static final int __POOLSEQ_ISSET_ID = 0;
  private static final int __INDEX_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.POOL_SEQ, new org.apache.thrift.meta_data.FieldMetaData("poolSeq", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  @Override
  public void clear() {
    setPoolSeqIsSet(false);
    this.poolSeq = 0;
    setIndexIsSet(false);
    this.index = 0;
  }

  public long getPoolSeq() {
    return this.poolSeq;
  }

  public TransactionId setPoolSeq(long poolSeq) {
    this.poolSeq = poolSeq;
    setPoolSeqIsSet(true);
    return this;
  }

  public void unsetPoolSeq() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __POOLSEQ_ISSET_ID);
  }

  /** Returns true if field poolSeq is set (has been assigned a value) and false otherwise */
  public boolean isSetPoolSeq() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __POOLSEQ_ISSET_ID);
  }

  public void setPoolSeqIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __POOLSEQ_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case POOL_SEQ:
      if (value == null) {
        ...
        setPoolSeq((java.lang.Long)value);
      }
      break;
  ...
  public boolean equals(TransactionId that) {
    ...
    boolean this_present_poolSeq = true;
    boolean that_present_poolSeq = true;
    if (this_present_poolSeq || that_present_poolSeq) {
      if (!(this_present_poolSeq && that_present_poolSeq))
        return false;
      if (this.poolSeq != that.poolSeq)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(poolSeq);
  ...
  public int compareTo(TransactionId other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPoolSeq()).compareTo(other.isSetPoolSeq());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPoolSeq()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.poolSeq, other.poolSeq);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TransactionIdStandardScheme extends org.apache.thrift.scheme.StandardScheme<TransactionId> {
        ...
        switch (schemeField.id) {
          case 1: // POOL_SEQ
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.poolSeq = iprot.readI64();
              struct.setPoolSeqIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionId struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(POOL_SEQ_FIELD_DESC);
      oprot.writeI64(struct.poolSeq);
      oprot.writeFieldEnd();
