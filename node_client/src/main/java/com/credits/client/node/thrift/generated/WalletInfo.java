...
public class WalletInfo implements org.apache.thrift.TBase<WalletInfo, WalletInfo._Fields>, java.io.Serializable, Cloneable, Comparable<WalletInfo> {
  ...
  public WalletInfo setAddress(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer address) {
    this.address = org.apache.thrift.TBaseHelper.copyBinary(address);
    return this;
  }
  ...
  public WalletInfo setBalance(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Amount balance) {
    this.balance = balance;
    return this;
  }
