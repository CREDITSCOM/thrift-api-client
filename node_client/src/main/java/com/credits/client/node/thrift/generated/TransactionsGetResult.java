...
public class TransactionsGetResult implements org.apache.thrift.TBase<TransactionsGetResult, TransactionsGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionsGetResult> {
  ...
  public TransactionsGetResult setStatus(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public TransactionsGetResult setTransactions(@org.apache.thrift.annotation.Nullable java.util.List<SealedTransaction> transactions) {
    this.transactions = transactions;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<SealedTransaction>(_list50.size);
                @org.apache.thrift.annotation.Nullable SealedTransaction _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new SealedTransaction();
                  _elem51.read(iprot);
                  struct.transactions.add(_elem51);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (SealedTransaction _iter53 : struct.transactions)
          {
            _iter53.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (SealedTransaction _iter54 : struct.transactions)
          {
            _iter54.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<SealedTransaction>(_list55.size);
          @org.apache.thrift.annotation.Nullable SealedTransaction _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new SealedTransaction();
            _elem56.read(iprot);
            struct.transactions.add(_elem56);
          }
        }
        struct.setTransactionsIsSet(true);
      }
