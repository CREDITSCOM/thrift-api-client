            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<Pool>(_list58.size);
                @org.apache.thrift.annotation.Nullable Pool _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new Pool();
                  _elem59.read(iprot);
                  struct.pools.add(_elem59);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.pools = new java.util.ArrayList<Pool>(_list63.size);
          @org.apache.thrift.annotation.Nullable Pool _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new Pool();
            _elem64.read(iprot);
            struct.pools.add(_elem64);
          }
        }
        struct.setPoolsIsSet(true);
      }
