...
public class PoolListGetResult implements org.apache.thrift.TBase<PoolListGetResult, PoolListGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<PoolListGetResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Pool> pools; // required
  ...
  public PoolListGetResult setStatus(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public PoolListGetResult setPools(@org.apache.thrift.annotation.Nullable java.util.List<Pool> pools) {
    this.pools = pools;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pools = new java.util.ArrayList<Pool>(_list66.size);
                @org.apache.thrift.annotation.Nullable Pool _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new Pool();
                  _elem67.read(iprot);
                  struct.pools.add(_elem67);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.pools = new java.util.ArrayList<Pool>(_list71.size);
          @org.apache.thrift.annotation.Nullable Pool _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new Pool();
            _elem72.read(iprot);
            struct.pools.add(_elem72);
          }
        }
        struct.setPoolsIsSet(true);
      }
