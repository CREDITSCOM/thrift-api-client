...
public class Transaction implements org.apache.thrift.TBase<Transaction, Transaction._Fields>, java.io.Serializable, Cloneable, Comparable<Transaction> {
  ...
  private static final org.apache.thrift.protocol.TField EXTRA_FEE_FIELD_DESC = new org.apache.thrift.protocol.TField("extraFee", org.apache.thrift.protocol.TType.LIST, (short)14);
  private static final org.apache.thrift.protocol.TField POOL_NUMBER_FIELD_DESC = new org.apache.thrift.protocol.TField("poolNumber", org.apache.thrift.protocol.TType.I64, (short)15);
  private static final org.apache.thrift.protocol.TField USED_CONTRACTS_FIELD_DESC = new org.apache.thrift.protocol.TField("usedContracts", org.apache.thrift.protocol.TType.LIST, (short)16);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<ExtraFee> extraFee; // optional
  public long poolNumber; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> usedContracts; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXTRA_FEE((short)14, "extraFee"),
    POOL_NUMBER((short)15, "poolNumber"),
    USED_CONTRACTS((short)16, "usedContracts");
  ...
  private static final int __POOLNUMBER_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SMART_CONTRACT,_Fields.USER_FIELDS,_Fields.SMART_INFO,_Fields.EXTRA_FEE,_Fields.USED_CONTRACTS};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXTRA_FEE, new org.apache.thrift.meta_data.FieldMetaData("extraFee", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ExtraFee.class))));
    ...
    tmpMap.put(_Fields.USED_CONTRACTS, new org.apache.thrift.meta_data.FieldMetaData("usedContracts", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , "Address"))));
  ...
  public Transaction(Transaction other) {
    ...
    if (other.isSetExtraFee()) {
      java.util.List<ExtraFee> __this__extraFee = new java.util.ArrayList<ExtraFee>(other.extraFee.size());
      for (ExtraFee other_element : other.extraFee) {
        __this__extraFee.add(new ExtraFee(other_element));
      }
      this.extraFee = __this__extraFee;
    }
  ...
  public int getExtraFeeSize() {
    return (this.extraFee == null) ? 0 : this.extraFee.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<ExtraFee> getExtraFeeIterator() {
    return (this.extraFee == null) ? null : this.extraFee.iterator();
  }

  public void addToExtraFee(ExtraFee elem) {
    if (this.extraFee == null) {
      this.extraFee = new java.util.ArrayList<ExtraFee>();
    }
    this.extraFee.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<ExtraFee> getExtraFee() {
    return this.extraFee;
  }

  public Transaction setExtraFee(@org.apache.thrift.annotation.Nullable java.util.List<ExtraFee> extraFee) {
    this.extraFee = extraFee;
    return this;
  }

  public void unsetExtraFee() {
    this.extraFee = null;
  }

  /** Returns true if field extraFee is set (has been assigned a value) and false otherwise */
  public boolean isSetExtraFee() {
    return this.extraFee != null;
  }

  public void setExtraFeeIsSet(boolean value) {
    if (!value) {
      this.extraFee = null;
    }
  }
  ...
  public Transaction setPoolNumber(long poolNumber) {
    this.poolNumber = poolNumber;
    setPoolNumberIsSet(true);
    return this;
  }
  ...
  public Transaction setUsedContracts(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> usedContracts) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case EXTRA_FEE:
      if (value == null) {
        ...
        setExtraFee((java.util.List<ExtraFee>)value);
      }
      break;
  ...
  public boolean equals(Transaction that) {
    ...
    boolean this_present_extraFee = true && this.isSetExtraFee();
    boolean that_present_extraFee = true && that.isSetExtraFee();
    if (this_present_extraFee || that_present_extraFee) {
      if (!(this_present_extraFee && that_present_extraFee))
        return false;
      if (!this.extraFee.equals(that.extraFee))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetExtraFee()) ? 131071 : 524287);
    if (isSetExtraFee())
      hashCode = hashCode * 8191 + extraFee.hashCode();
  ...
  public int compareTo(Transaction other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExtraFee()).compareTo(other.isSetExtraFee());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExtraFee()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.extraFee, other.extraFee);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TransactionStandardScheme extends org.apache.thrift.scheme.StandardScheme<Transaction> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.extraFee = new java.util.ArrayList<ExtraFee>(_list32.size);
                @org.apache.thrift.annotation.Nullable ExtraFee _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new ExtraFee();
                  _elem33.read(iprot);
                  struct.extraFee.add(_elem33);
                }
                iprot.readListEnd();
              }
              struct.setExtraFeeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.usedContracts = new java.util.ArrayList<java.nio.ByteBuffer>(_list35.size);
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = iprot.readBinary();
                  struct.usedContracts.add(_elem36);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Transaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.extraFee != null) {
        if (struct.isSetExtraFee()) {
          oprot.writeFieldBegin(EXTRA_FEE_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.extraFee.size()));
            for (ExtraFee _iter38 : struct.extraFee)
            {
              _iter38.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.usedContracts != null) {
        if (struct.isSetUsedContracts()) {
          oprot.writeFieldBegin(USED_CONTRACTS_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter39 : struct.usedContracts)
            {
  ...
  private static class TransactionTupleScheme extends org.apache.thrift.scheme.TupleScheme<Transaction> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Transaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetExtraFee()) {
        {
          oprot.writeI32(struct.extraFee.size());
          for (ExtraFee _iter40 : struct.extraFee)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (struct.isSetUsedContracts()) {
        {
          ...
          for (java.nio.ByteBuffer _iter41 : struct.usedContracts)
          {
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.extraFee = new java.util.ArrayList<ExtraFee>(_list42.size);
          @org.apache.thrift.annotation.Nullable ExtraFee _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = new ExtraFee();
            _elem43.read(iprot);
            struct.extraFee.add(_elem43);
          }
        }
        struct.setExtraFeeIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.usedContracts = new java.util.ArrayList<java.nio.ByteBuffer>(_list45.size);
          @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = iprot.readBinary();
            struct.usedContracts.add(_elem46);
          }
        }
        struct.setUsedContractsIsSet(true);
      }
