...
public class Transaction implements org.apache.thrift.TBase<Transaction, Transaction._Fields>, java.io.Serializable, Cloneable, Comparable<Transaction> {
  ...
  private static final _Fields optionals[] = {_Fields.SMART_CONTRACT,_Fields.USER_FIELDS,_Fields.SMART_INFO,_Fields.EXTRA_FEE};
      ...
      if (struct.extraFee != null) {
        if (struct.isSetExtraFee()) {
          oprot.writeFieldBegin(EXTRA_FEE_FIELD_DESC);
          {
            ...
            for (ExtraFee _iter35 : struct.extraFee)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetExtraFee()) {
        {
          ...
          for (ExtraFee _iter36 : struct.extraFee)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.extraFee = new java.util.ArrayList<ExtraFee>(_list37.size);
          @org.apache.thrift.annotation.Nullable ExtraFee _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new ExtraFee();
            _elem38.read(iprot);
            struct.extraFee.add(_elem38);
          }
        }
        struct.setExtraFeeIsSet(true);
      }
