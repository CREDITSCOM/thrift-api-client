            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.wallets = new java.util.ArrayList<WalletInfo>(_list214.size);
                @org.apache.thrift.annotation.Nullable WalletInfo _elem215;
                for (int _i216 = 0; _i216 < _list214.size; ++_i216)
                {
                  _elem215 = new WalletInfo();
                  _elem215.read(iprot);
                  struct.wallets.add(_elem215);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WalletsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.wallets != null) {
        oprot.writeFieldBegin(WALLETS_FIELD_DESC);
        {
          ...
          for (WalletInfo _iter217 : struct.wallets)
          {
      ...
      if (struct.isSetWallets()) {
        {
          ...
          for (WalletInfo _iter218 : struct.wallets)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.wallets = new java.util.ArrayList<WalletInfo>(_list219.size);
          @org.apache.thrift.annotation.Nullable WalletInfo _elem220;
          for (int _i221 = 0; _i221 < _list219.size; ++_i221)
          {
            _elem220 = new WalletInfo();
            _elem220.read(iprot);
            struct.wallets.add(_elem220);
          }
        }
        struct.setWalletsIsSet(true);
      }
