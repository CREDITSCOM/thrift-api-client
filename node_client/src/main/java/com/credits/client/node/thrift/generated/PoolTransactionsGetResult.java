            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<SealedTransaction>(_list66.size);
                @org.apache.thrift.annotation.Nullable SealedTransaction _elem67;
                for (int _i68 = 0; _i68 < _list66.size; ++_i68)
                {
                  _elem67 = new SealedTransaction();
                  _elem67.read(iprot);
                  struct.transactions.add(_elem67);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PoolTransactionsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (SealedTransaction _iter69 : struct.transactions)
          {
            _iter69.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (SealedTransaction _iter70 : struct.transactions)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<SealedTransaction>(_list71.size);
          @org.apache.thrift.annotation.Nullable SealedTransaction _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new SealedTransaction();
            _elem72.read(iprot);
            struct.transactions.add(_elem72);
          }
        }
        struct.setTransactionsIsSet(true);
      }
