            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transactions = new java.util.ArrayList<TokenTransaction>(_list182.size);
                @org.apache.thrift.annotation.Nullable TokenTransaction _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new TokenTransaction();
                  _elem183.read(iprot);
                  struct.transactions.add(_elem183);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransactionsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transactions != null) {
        oprot.writeFieldBegin(TRANSACTIONS_FIELD_DESC);
        {
          ...
          for (TokenTransaction _iter185 : struct.transactions)
          {
      ...
      if (struct.isSetTransactions()) {
        {
          ...
          for (TokenTransaction _iter186 : struct.transactions)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transactions = new java.util.ArrayList<TokenTransaction>(_list187.size);
          @org.apache.thrift.annotation.Nullable TokenTransaction _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = new TokenTransaction();
            _elem188.read(iprot);
            struct.transactions.add(_elem188);
          }
        }
        struct.setTransactionsIsSet(true);
      }
