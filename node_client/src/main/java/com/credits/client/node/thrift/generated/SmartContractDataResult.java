            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<SmartContractMethod>(_list140.size);
                @org.apache.thrift.annotation.Nullable SmartContractMethod _elem141;
                for (int _i142 = 0; _i142 < _list140.size; ++_i142)
                {
                  _elem141 = new SmartContractMethod();
                  _elem141.read(iprot);
                  struct.methods.add(_elem141);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map143.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key144;
                @org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Variant _val145;
                for (int _i146 = 0; _i146 < _map143.size; ++_i146)
                {
                  _key144 = iprot.readString();
                  _val145 = new com.credits.general.thrift.generated.Variant();
                  _val145.read(iprot);
                  struct.variables.put(_key144, _val145);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractDataResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (SmartContractMethod _iter147 : struct.methods)
          {
      ...
      if (struct.variables != null) {
        oprot.writeFieldBegin(VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter148 : struct.variables.entrySet())
          {
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (SmartContractMethod _iter149 : struct.methods)
          {
      ...
      if (struct.isSetVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter150 : struct.variables.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<SmartContractMethod>(_list151.size);
          @org.apache.thrift.annotation.Nullable SmartContractMethod _elem152;
          for (int _i153 = 0; _i153 < _list151.size; ++_i153)
          {
            _elem152 = new SmartContractMethod();
            _elem152.read(iprot);
            struct.methods.add(_elem152);
          }
        }
        struct.setMethodsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map154.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key155;
          @org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Variant _val156;
          for (int _i157 = 0; _i157 < _map154.size; ++_i157)
          {
            _key155 = iprot.readString();
            _val156 = new com.credits.general.thrift.generated.Variant();
            _val156.read(iprot);
            struct.variables.put(_key155, _val156);
          }
        }
        struct.setVariablesIsSet(true);
      }
