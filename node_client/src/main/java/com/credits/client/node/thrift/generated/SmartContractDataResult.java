            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<SmartContractMethod>(_list132.size);
                @org.apache.thrift.annotation.Nullable SmartContractMethod _elem133;
                for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                {
                  _elem133 = new SmartContractMethod();
                  _elem133.read(iprot);
                  struct.methods.add(_elem133);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map135.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key136;
                @org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Variant _val137;
                for (int _i138 = 0; _i138 < _map135.size; ++_i138)
                {
                  _key136 = iprot.readString();
                  _val137 = new com.credits.general.thrift.generated.Variant();
                  _val137.read(iprot);
                  struct.variables.put(_key136, _val137);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractDataResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (SmartContractMethod _iter139 : struct.methods)
          {
      ...
      if (struct.variables != null) {
        oprot.writeFieldBegin(VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter140 : struct.variables.entrySet())
          {
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (SmartContractMethod _iter141 : struct.methods)
          {
      ...
      if (struct.isSetVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.general.thrift.generated.Variant> _iter142 : struct.variables.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<SmartContractMethod>(_list143.size);
          @org.apache.thrift.annotation.Nullable SmartContractMethod _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = new SmartContractMethod();
            _elem144.read(iprot);
            struct.methods.add(_elem144);
          }
        }
        struct.setMethodsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.variables = new java.util.HashMap<java.lang.String,com.credits.general.thrift.generated.Variant>(2*_map146.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key147;
          @org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Variant _val148;
          for (int _i149 = 0; _i149 < _map146.size; ++_i149)
          {
            _key147 = iprot.readString();
            _val148 = new com.credits.general.thrift.generated.Variant();
            _val148.read(iprot);
            struct.variables.put(_key147, _val148);
          }
        }
        struct.setVariablesIsSet(true);
      }
