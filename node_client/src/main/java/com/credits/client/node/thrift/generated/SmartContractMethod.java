            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list124.size);
                @org.apache.thrift.annotation.Nullable SmartContractMethodArgument _elem125;
                for (int _i126 = 0; _i126 < _list124.size; ++_i126)
                {
                  _elem125 = new SmartContractMethodArgument();
                  _elem125.read(iprot);
                  struct.arguments.add(_elem125);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractMethod struct) throws org.apache.thrift.TException {
      ...
      if (struct.arguments != null) {
        oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
        {
          ...
          for (SmartContractMethodArgument _iter127 : struct.arguments)
          {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (SmartContractMethodArgument _iter128 : struct.arguments)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<SmartContractMethodArgument>(_list129.size);
          @org.apache.thrift.annotation.Nullable SmartContractMethodArgument _elem130;
          for (int _i131 = 0; _i131 < _list129.size; ++_i131)
          {
            _elem130 = new SmartContractMethodArgument();
            _elem130.read(iprot);
            struct.arguments.add(_elem130);
          }
        }
        struct.setArgumentsIsSet(true);
      }
