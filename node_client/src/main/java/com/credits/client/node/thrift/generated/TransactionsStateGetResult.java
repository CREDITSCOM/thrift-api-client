...
public class TransactionsStateGetResult implements org.apache.thrift.TBase<TransactionsStateGetResult, TransactionsStateGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionsStateGetResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map106.size);
                long _key107;
                @org.apache.thrift.annotation.Nullable TransactionState _val108;
                for (int _i109 = 0; _i109 < _map106.size; ++_i109)
                {
                  _key107 = iprot.readI64();
                  _val108 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
                  struct.states.put(_key107, _val108);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.states != null) {
        oprot.writeFieldBegin(STATES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter110 : struct.states.entrySet())
          {
            oprot.writeI64(_iter110.getKey());
            oprot.writeI32(_iter110.getValue().getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TransactionsStateGetResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TransactionsStateGetResult> {
      ...
      if (struct.isSetStates()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter111 : struct.states.entrySet())
          {
            oprot.writeI64(_iter111.getKey());
            oprot.writeI32(_iter111.getValue().getValue());
          }
        }
      }
      if (struct.isSetRoundNum()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map112 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map112.size);
          long _key113;
          @org.apache.thrift.annotation.Nullable TransactionState _val114;
          for (int _i115 = 0; _i115 < _map112.size; ++_i115)
          {
            _key113 = iprot.readI64();
            _val114 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
            struct.states.put(_key113, _val114);
          }
        }
        struct.setStatesIsSet(true);
      }
