...
public class TransactionsStateGetResult implements org.apache.thrift.TBase<TransactionsStateGetResult, TransactionsStateGetResult._Fields>, java.io.Serializable, Cloneable, Comparable<TransactionsStateGetResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map98.size);
                long _key99;
                @org.apache.thrift.annotation.Nullable TransactionState _val100;
                for (int _i101 = 0; _i101 < _map98.size; ++_i101)
                {
                  _key99 = iprot.readI64();
                  _val100 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
                  struct.states.put(_key99, _val100);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.states != null) {
        oprot.writeFieldBegin(STATES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter102 : struct.states.entrySet())
          {
            oprot.writeI64(_iter102.getKey());
            oprot.writeI32(_iter102.getValue().getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TransactionsStateGetResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TransactionsStateGetResult> {
      ...
      if (struct.isSetStates()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TransactionState> _iter103 : struct.states.entrySet())
          {
            oprot.writeI64(_iter103.getKey());
            oprot.writeI32(_iter103.getValue().getValue());
          }
        }
      }
      if (struct.isSetRoundNum()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TransactionsStateGetResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map104 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.states = new java.util.HashMap<java.lang.Long,TransactionState>(2*_map104.size);
          long _key105;
          @org.apache.thrift.annotation.Nullable TransactionState _val106;
          for (int _i107 = 0; _i107 < _map104.size; ++_i107)
          {
            _key105 = iprot.readI64();
            _val106 = com.credits.client.node.thrift.generated.TransactionState.findByValue(iprot.readI32());
            struct.states.put(_key105, _val106);
          }
        }
        struct.setStatesIsSet(true);
      }
