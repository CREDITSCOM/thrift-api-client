            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stats = new java.util.ArrayList<PeriodStats>(_list82.size);
                @org.apache.thrift.annotation.Nullable PeriodStats _elem83;
                for (int _i84 = 0; _i84 < _list82.size; ++_i84)
                {
                  _elem83 = new PeriodStats();
                  _elem83.read(iprot);
                  struct.stats.add(_elem83);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.stats != null) {
        oprot.writeFieldBegin(STATS_FIELD_DESC);
        {
          ...
          for (PeriodStats _iter85 : struct.stats)
          {
            _iter85.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStats()) {
        {
          ...
          for (PeriodStats _iter86 : struct.stats)
          {
            _iter86.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.stats = new java.util.ArrayList<PeriodStats>(_list87.size);
          @org.apache.thrift.annotation.Nullable PeriodStats _elem88;
          for (int _i89 = 0; _i89 < _list87.size; ++_i89)
          {
            _elem88 = new PeriodStats();
            _elem88.read(iprot);
            struct.stats.add(_elem88);
          }
        }
        struct.setStatsIsSet(true);
      }
