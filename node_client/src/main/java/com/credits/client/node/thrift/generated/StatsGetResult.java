            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stats = new java.util.ArrayList<PeriodStats>(_list74.size);
                @org.apache.thrift.annotation.Nullable PeriodStats _elem75;
                for (int _i76 = 0; _i76 < _list74.size; ++_i76)
                {
                  _elem75 = new PeriodStats();
                  _elem75.read(iprot);
                  struct.stats.add(_elem75);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatsGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.stats != null) {
        oprot.writeFieldBegin(STATS_FIELD_DESC);
        {
          ...
          for (PeriodStats _iter77 : struct.stats)
          {
            _iter77.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetStats()) {
        {
          ...
          for (PeriodStats _iter78 : struct.stats)
          {
            _iter78.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.stats = new java.util.ArrayList<PeriodStats>(_list79.size);
          @org.apache.thrift.annotation.Nullable PeriodStats _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new PeriodStats();
            _elem80.read(iprot);
            struct.stats.add(_elem80);
          }
        }
        struct.setStatsIsSet(true);
      }
