            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list98.size);
                @org.apache.thrift.annotation.Nullable SmartContract _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new SmartContract();
                  _elem99.read(iprot);
                  struct.smartContractsList.add(_elem99);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SmartContractsListGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.smartContractsList != null) {
        oprot.writeFieldBegin(SMART_CONTRACTS_LIST_FIELD_DESC);
        {
          ...
          for (SmartContract _iter101 : struct.smartContractsList)
          {
      ...
      if (struct.isSetSmartContractsList()) {
        {
          ...
          for (SmartContract _iter102 : struct.smartContractsList)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.smartContractsList = new java.util.ArrayList<SmartContract>(_list103.size);
          @org.apache.thrift.annotation.Nullable SmartContract _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new SmartContract();
            _elem104.read(iprot);
            struct.smartContractsList.add(_elem104);
          }
        }
        struct.setSmartContractsListIsSet(true);
      }
