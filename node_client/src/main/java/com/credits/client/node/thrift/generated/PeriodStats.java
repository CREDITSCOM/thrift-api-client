...
public class PeriodStats implements org.apache.thrift.TBase<PeriodStats, PeriodStats._Fields>, java.io.Serializable, Cloneable, Comparable<PeriodStats> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Byte,CumulativeAmount> balancePerCurrency; // required
  ...
  public PeriodStats setBalancePerCurrency(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Byte,CumulativeAmount> balancePerCurrency) {
    this.balancePerCurrency = balancePerCurrency;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map48.size);
                byte _key49;
                @org.apache.thrift.annotation.Nullable CumulativeAmount _val50;
                for (int _i51 = 0; _i51 < _map48.size; ++_i51)
                {
                  _key49 = iprot.readByte();
                  _val50 = new CumulativeAmount();
                  _val50.read(iprot);
                  struct.balancePerCurrency.put(_key49, _val50);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.balancePerCurrency != null) {
        oprot.writeFieldBegin(BALANCE_PER_CURRENCY_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter52 : struct.balancePerCurrency.entrySet())
          {
            oprot.writeByte(_iter52.getKey());
  ...
  private static class PeriodStatsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PeriodStats> {
      ...
      if (struct.isSetBalancePerCurrency()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter53 : struct.balancePerCurrency.entrySet())
          {
            oprot.writeByte(_iter53.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map54 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.BYTE, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map54.size);
          byte _key55;
          @org.apache.thrift.annotation.Nullable CumulativeAmount _val56;
          for (int _i57 = 0; _i57 < _map54.size; ++_i57)
          {
            _key55 = iprot.readByte();
            _val56 = new CumulativeAmount();
            _val56.read(iprot);
            struct.balancePerCurrency.put(_key55, _val56);
          }
        }
        struct.setBalancePerCurrencyIsSet(true);
      }
