...
public class PeriodStats implements org.apache.thrift.TBase<PeriodStats, PeriodStats._Fields>, java.io.Serializable, Cloneable, Comparable<PeriodStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map40.size);
                byte _key41;
                @org.apache.thrift.annotation.Nullable CumulativeAmount _val42;
                for (int _i43 = 0; _i43 < _map40.size; ++_i43)
                {
                  _key41 = iprot.readByte();
                  _val42 = new CumulativeAmount();
                  _val42.read(iprot);
                  struct.balancePerCurrency.put(_key41, _val42);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (struct.balancePerCurrency != null) {
        oprot.writeFieldBegin(BALANCE_PER_CURRENCY_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter44 : struct.balancePerCurrency.entrySet())
          {
  ...
  private static class PeriodStatsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PeriodStats> {
      ...
      if (struct.isSetBalancePerCurrency()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Byte, CumulativeAmount> _iter45 : struct.balancePerCurrency.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PeriodStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map46 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.BYTE, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.balancePerCurrency = new java.util.HashMap<java.lang.Byte,CumulativeAmount>(2*_map46.size);
          byte _key47;
          @org.apache.thrift.annotation.Nullable CumulativeAmount _val48;
          for (int _i49 = 0; _i49 < _map46.size; ++_i49)
          {
            _key47 = iprot.readByte();
            _val48 = new CumulativeAmount();
            _val48.read(iprot);
            struct.balancePerCurrency.put(_key47, _val48);
          }
        }
        struct.setBalancePerCurrencyIsSet(true);
      }
