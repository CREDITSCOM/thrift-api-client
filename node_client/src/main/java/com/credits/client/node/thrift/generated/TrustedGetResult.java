            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writers = new java.util.ArrayList<TrustedInfo>(_list222.size);
                @org.apache.thrift.annotation.Nullable TrustedInfo _elem223;
                for (int _i224 = 0; _i224 < _list222.size; ++_i224)
                {
                  _elem223 = new TrustedInfo();
                  _elem223.read(iprot);
                  struct.writers.add(_elem223);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TrustedGetResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.writers != null) {
        oprot.writeFieldBegin(WRITERS_FIELD_DESC);
        {
          ...
          for (TrustedInfo _iter225 : struct.writers)
          {
      ...
      if (struct.isSetWriters()) {
        {
          ...
          for (TrustedInfo _iter226 : struct.writers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.writers = new java.util.ArrayList<TrustedInfo>(_list227.size);
          @org.apache.thrift.annotation.Nullable TrustedInfo _elem228;
          for (int _i229 = 0; _i229 < _list227.size; ++_i229)
          {
            _elem228 = new TrustedInfo();
            _elem228.read(iprot);
            struct.writers.add(_elem228);
          }
        }
        struct.setWritersIsSet(true);
      }
