            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transfers = new java.util.ArrayList<TokenTransfer>(_list174.size);
                @org.apache.thrift.annotation.Nullable TokenTransfer _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = new TokenTransfer();
                  _elem175.read(iprot);
                  struct.transfers.add(_elem175);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransfersResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transfers != null) {
        oprot.writeFieldBegin(TRANSFERS_FIELD_DESC);
        {
          ...
          for (TokenTransfer _iter177 : struct.transfers)
          {
      ...
      if (struct.isSetTransfers()) {
        {
          ...
          for (TokenTransfer _iter178 : struct.transfers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transfers = new java.util.ArrayList<TokenTransfer>(_list179.size);
          @org.apache.thrift.annotation.Nullable TokenTransfer _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new TokenTransfer();
            _elem180.read(iprot);
            struct.transfers.add(_elem180);
          }
        }
        struct.setTransfersIsSet(true);
      }
