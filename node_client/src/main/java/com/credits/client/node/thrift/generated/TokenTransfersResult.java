            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.transfers = new java.util.ArrayList<TokenTransfer>(_list182.size);
                @org.apache.thrift.annotation.Nullable TokenTransfer _elem183;
                for (int _i184 = 0; _i184 < _list182.size; ++_i184)
                {
                  _elem183 = new TokenTransfer();
                  _elem183.read(iprot);
                  struct.transfers.add(_elem183);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenTransfersResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.transfers != null) {
        oprot.writeFieldBegin(TRANSFERS_FIELD_DESC);
        {
          ...
          for (TokenTransfer _iter185 : struct.transfers)
          {
      ...
      if (struct.isSetTransfers()) {
        {
          ...
          for (TokenTransfer _iter186 : struct.transfers)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.transfers = new java.util.ArrayList<TokenTransfer>(_list187.size);
          @org.apache.thrift.annotation.Nullable TokenTransfer _elem188;
          for (int _i189 = 0; _i189 < _list187.size; ++_i189)
          {
            _elem188 = new TokenTransfer();
            _elem188.read(iprot);
            struct.transfers.add(_elem188);
          }
        }
        struct.setTransfersIsSet(true);
      }
