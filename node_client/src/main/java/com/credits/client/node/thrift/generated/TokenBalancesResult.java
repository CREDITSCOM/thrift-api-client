            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.balances = new java.util.ArrayList<TokenBalance>(_list174.size);
                @org.apache.thrift.annotation.Nullable TokenBalance _elem175;
                for (int _i176 = 0; _i176 < _list174.size; ++_i176)
                {
                  _elem175 = new TokenBalance();
                  _elem175.read(iprot);
                  struct.balances.add(_elem175);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenBalancesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.balances != null) {
        oprot.writeFieldBegin(BALANCES_FIELD_DESC);
        {
          ...
          for (TokenBalance _iter177 : struct.balances)
          {
      ...
      if (struct.isSetBalances()) {
        {
          ...
          for (TokenBalance _iter178 : struct.balances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.balances = new java.util.ArrayList<TokenBalance>(_list179.size);
          @org.apache.thrift.annotation.Nullable TokenBalance _elem180;
          for (int _i181 = 0; _i181 < _list179.size; ++_i181)
          {
            _elem180 = new TokenBalance();
            _elem180.read(iprot);
            struct.balances.add(_elem180);
          }
        }
        struct.setBalancesIsSet(true);
      }
