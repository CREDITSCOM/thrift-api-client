...
public class TokenBalancesResult implements org.apache.thrift.TBase<TokenBalancesResult, TokenBalancesResult._Fields>, java.io.Serializable, Cloneable, Comparable<TokenBalancesResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TokenBalance> balances; // required
  ...
  public TokenBalancesResult setStatus(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public TokenBalancesResult setBalances(@org.apache.thrift.annotation.Nullable java.util.List<TokenBalance> balances) {
    this.balances = balances;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.balances = new java.util.ArrayList<TokenBalance>(_list166.size);
                @org.apache.thrift.annotation.Nullable TokenBalance _elem167;
                for (int _i168 = 0; _i168 < _list166.size; ++_i168)
                {
                  _elem167 = new TokenBalance();
                  _elem167.read(iprot);
                  struct.balances.add(_elem167);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TokenBalancesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.balances != null) {
        oprot.writeFieldBegin(BALANCES_FIELD_DESC);
        {
          ...
          for (TokenBalance _iter169 : struct.balances)
          {
      ...
      if (struct.isSetBalances()) {
        {
          ...
          for (TokenBalance _iter170 : struct.balances)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.balances = new java.util.ArrayList<TokenBalance>(_list171.size);
          @org.apache.thrift.annotation.Nullable TokenBalance _elem172;
          for (int _i173 = 0; _i173 < _list171.size; ++_i173)
          {
            _elem172 = new TokenBalance();
            _elem172.read(iprot);
            struct.balances.add(_elem172);
          }
        }
        struct.setBalancesIsSet(true);
      }
