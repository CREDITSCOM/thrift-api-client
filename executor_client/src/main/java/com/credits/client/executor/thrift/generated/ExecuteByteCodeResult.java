    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (SetterMethodResult _iter3 : struct.results)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (SetterMethodResult _iter4 : struct.results)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.results = new java.util.ArrayList<SetterMethodResult>(_list5.size);
          @org.apache.thrift.annotation.Nullable SetterMethodResult _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new SetterMethodResult();
            _elem6.read(iprot);
