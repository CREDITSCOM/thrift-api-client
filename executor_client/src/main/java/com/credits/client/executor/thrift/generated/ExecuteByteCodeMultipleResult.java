            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<GetterMethodResult>(_list26.size);
                @org.apache.thrift.annotation.Nullable GetterMethodResult _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = new GetterMethodResult();
                  _elem27.read(iprot);
                  struct.results.add(_elem27);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeMultipleResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (GetterMethodResult _iter29 : struct.results)
          {
            _iter29.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (GetterMethodResult _iter30 : struct.results)
          {
            _iter30.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.results = new java.util.ArrayList<GetterMethodResult>(_list31.size);
          @org.apache.thrift.annotation.Nullable GetterMethodResult _elem32;
          for (int _i33 = 0; _i33 < _list31.size; ++_i33)
          {
            _elem32 = new GetterMethodResult();
            _elem32.read(iprot);
