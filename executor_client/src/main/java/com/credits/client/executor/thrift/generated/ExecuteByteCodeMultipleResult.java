...
public class ExecuteByteCodeMultipleResult implements org.apache.thrift.TBase<ExecuteByteCodeMultipleResult, ExecuteByteCodeMultipleResult._Fields>, java.io.Serializable, Cloneable, Comparable<ExecuteByteCodeMultipleResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<GetterMethodResult> results; // required
  ...
  public ExecuteByteCodeMultipleResult setStatus(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public ExecuteByteCodeMultipleResult setResults(@org.apache.thrift.annotation.Nullable java.util.List<GetterMethodResult> results) {
    this.results = results;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<GetterMethodResult>(_list44.size);
                @org.apache.thrift.annotation.Nullable GetterMethodResult _elem45;
                for (int _i46 = 0; _i46 < _list44.size; ++_i46)
                {
                  _elem45 = new GetterMethodResult();
                  _elem45.read(iprot);
                  struct.results.add(_elem45);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeMultipleResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (GetterMethodResult _iter47 : struct.results)
          {
            _iter47.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (GetterMethodResult _iter48 : struct.results)
          {
            _iter48.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.results = new java.util.ArrayList<GetterMethodResult>(_list49.size);
          @org.apache.thrift.annotation.Nullable GetterMethodResult _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = new GetterMethodResult();
            _elem50.read(iprot);
            struct.results.add(_elem50);
          }
        }
        struct.setResultsIsSet(true);
      }
