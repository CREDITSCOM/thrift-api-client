            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<GetterMethodResult>(_list18.size);
                @org.apache.thrift.annotation.Nullable GetterMethodResult _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = new GetterMethodResult();
                  _elem19.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecuteByteCodeMultipleResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (GetterMethodResult _iter21 : struct.results)
          {
            _iter21.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (GetterMethodResult _iter22 : struct.results)
          {
            _iter22.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.results = new java.util.ArrayList<GetterMethodResult>(_list23.size);
          @org.apache.thrift.annotation.Nullable GetterMethodResult _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new GetterMethodResult();
            _elem24.read(iprot);
            struct.results.add(_elem24);
          }
        }
        struct.setResultsIsSet(true);
      }
