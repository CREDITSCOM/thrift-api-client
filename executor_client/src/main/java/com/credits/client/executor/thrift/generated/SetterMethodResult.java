    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SetterMethodResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.contractsState != null) {
        oprot.writeFieldBegin(CONTRACTS_STATE_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter12 : struct.contractsState.entrySet())
          {
      ...
      if (struct.isSetContractsState()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter13 : struct.contractsState.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.contractsState = new java.util.HashMap<java.nio.ByteBuffer,java.nio.ByteBuffer>(2*_map14.size);
          ...
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.contractsState.put(_key15, _val16);
          }
        }
        struct.setContractsStateIsSet(true);
      }
