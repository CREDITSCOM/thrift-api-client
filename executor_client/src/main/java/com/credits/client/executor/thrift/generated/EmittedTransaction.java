...
public class EmittedTransaction implements org.apache.thrift.TBase<EmittedTransaction, EmittedTransaction._Fields>, java.io.Serializable, Cloneable, Comparable<EmittedTransaction> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("EmittedTransaction");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new EmittedTransactionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new EmittedTransactionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EmittedTransaction.class, metaDataMap);
  }

  public EmittedTransaction() {
  }
   ...
   */
  public EmittedTransaction(EmittedTransaction other) {
  ...
  public EmittedTransaction deepCopy() {
    return new EmittedTransaction(this);
  }
  ...
  public EmittedTransaction setSource(byte[] source) {
    this.source = source == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(source.clone());
    return this;
  }

  public EmittedTransaction setSource(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer source) {
    this.source = org.apache.thrift.TBaseHelper.copyBinary(source);
    return this;
  }
  ...
  public EmittedTransaction setTarget(byte[] target) {
    this.target = target == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(target.clone());
    return this;
  }

  public EmittedTransaction setTarget(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer target) {
    this.target = org.apache.thrift.TBaseHelper.copyBinary(target);
    return this;
  }
  ...
  public EmittedTransaction setAmount(@org.apache.thrift.annotation.Nullable com.credits.general.thrift.generated.Amount amount) {
    this.amount = amount;
    return this;
  }
  ...
  public EmittedTransaction setUserData(byte[] userData) {
    this.userData = userData == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(userData.clone());
    return this;
  }

  public EmittedTransaction setUserData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer userData) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof EmittedTransaction)
      return this.equals((EmittedTransaction)that);
    return false;
  }

  public boolean equals(EmittedTransaction that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(EmittedTransaction other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("EmittedTransaction(");
    boolean first = true;
  ...
  private static class EmittedTransactionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public EmittedTransactionStandardScheme getScheme() {
      return new EmittedTransactionStandardScheme();
    }
  }

  private static class EmittedTransactionStandardScheme extends org.apache.thrift.scheme.StandardScheme<EmittedTransaction> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EmittedTransaction struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EmittedTransaction struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class EmittedTransactionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public EmittedTransactionTupleScheme getScheme() {
      return new EmittedTransactionTupleScheme();
    }
  }

  private static class EmittedTransactionTupleScheme extends org.apache.thrift.scheme.TupleScheme<EmittedTransaction> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EmittedTransaction struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EmittedTransaction struct) throws org.apache.thrift.TException {
